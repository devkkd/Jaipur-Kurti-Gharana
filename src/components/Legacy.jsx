  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-6 md:py-8 font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-12 items-center">
        ...
        {/* Right Side: Content */}
        <div className="flex flex-col justify-center text-center lg:text-right space-y-4 order-1 lg:order-2">
          <header className="space-y-1">
            <h3 className="text-[10px] md:text-2xl  font-playfair font-bold  text-[#E13C6C] ">
              A Legacy of Artisanal
            </h3>
            <h2 className="text-3xl md:text-5xl font-bold font-playfair text-[#1F1951] ">
              Mastery
            </h2>
          </header>
