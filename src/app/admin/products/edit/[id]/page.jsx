...
export default function EditProductPage({ params }) {
  ...
  // Fetch product data and other required data
  useEffect(() => {
    if (!productId) return;
        ...
        if (productData.success) {
          ...
          setFormData({
            ...
            productDetails: {
              ...
              productCare: product.productDetails?.productCare || '',
              additionalInfo: product.productDetails?.additionalInfo || ''
            },
            color: {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Color */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Color Information</h2>
